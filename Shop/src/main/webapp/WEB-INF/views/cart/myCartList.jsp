...
<style>
.stm,.stm .btn{overflow:hidden;height:36px}
.stm .btn{float:left;width:35px;border:0;font-size:0;text-indent:-9999px}
.stm .btn.minus{background-image:url(https://res.kurly.com/mobile/service/cart/2007/ico_minus_on.svg)}
.stm .btn.minus,.stm .btn.minus.off{background-color:transparent;background-repeat:no-repeat;background-size:36px 36px;background-position:50% 50%}
.stm .btn.minus.off{background-image:url(https://res.kurly.com/mobile/service/cart/2007/ico_minus.svg)}
.stm .btn.plus{background-image:url(https://res.kurly.com/mobile/service/cart/2007/ico_plus_on.svg)}
.stm .btn.plus,.stm .btn.plus.off{background-color:transparent;background-repeat:no-repeat;background-size:36px 36px;background-position:50% 50%}
.stm .btn.plus.off{background-image:url(https://res.kurly.com/mobile/service/cart/2007/ico_plus.svg)}
.stm .num{float:left;width:29px;height:36px;padding:0;border:100px;font-weight:600;font-size:14px;color:#333;line-height:50px;text-align:center}
</style>
    <body>
    <!-- PAGE TITLE -->
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 order-md-1 mb-5">
							...
							<form method="post" action="#" name="form">
								<c:choose>
									<c:when test="${ empty myCartList }">
										...
										<div class="text-center mb-5">
											...
											<img class="img-fluid max-w-350" src="${contextPath}/demo.files/svg/ecommerce/undraw_empty_cart_co35.svg" alt="왜안떠..">
								...
								<div class="cart-item shadow-xs p-3 mb-4 rounded border">
									...
									<c:set var = "product_stock"    value="${myProductList[cnt.count-1].stock}" />
									<c:set var = "total_price"      value="${total_price+((product_price-product_discount)*cart_product_qty)}"/>
									<c:set var = "total_discount"   value="${total_discount+(cart_product_qty*product_discount)}" />
									
									<div class="row">

										<div class="col-4 col-sm-4 col-md-2 col-lg-2 text-center">

											<img class="img-fluid max-h-80" src="${contextPath}/resources/images/item_image/${product_image}" alt="...">
						...
						<!-- <input type="button" value=" + " onclick="add();">
								...
								<div class="clearfix mb-4 text-align-end">
									...
									<button type="button" class="btn btn-sm btn-secondary" onclick="javascript:deleteAllProduct();">
