...
<header id="header" class="shadow-xs">
	...
	<!-- TOP BAR -->
	<div id="top_bar" class="bg-purple-market fs--14">
				...
				<div class="d-flex justify-content-between">
					...
					<div class="d-inline-block float-start">
						<ul class="list-inline m-0">
							...
							<li class="dropdown list-inline-item m-0"><a
								...
								aria-haspopup="true"> <i class="flag flag-kr"></i> <span
									class="text-muted-white pl-2 pr-2">한국어</span>
							</a>
					...
					<div class="d-inline-block float-end">
						...
						<ul class="list-inline m-0">
							...
							<li class="dropdown list-inline-item"><a
								href="tel:+01-555-5555"
								class="p-2 d-inline-block font-weight-medium"
								style="color: #fff;"> <i class="float-start fi fi-phone"></i>
									02-3486-9600
							</a></li>
		...
		<nav
			...
			<div class="align-items-start">
				...
				<a class="navbar-brand m-0" href="${contextPath }/main/main.do">
					<img src="${contextPath}/resources/images/drjjlogo.svg" width="140"
					height="100" alt="...">
				</a>
			...
			<form action="search-result-2.html" method="GET"
				...
				<div class="sow-search-input w-100">
					...
					<div
						class="input-group-over d-flex align-items-center w-100 h-100 rounded form-control-pill">

						<input placeholder="오늘 뭐 먹지?"
							aria-label="what are you looking today?" name="s" type="text"
							class="form-control-sow-search form-control form-control-lg"
			...
			<ul class="list-inline list-unstyled mb-0 d-flex align-items-end">
				...
				<li class="list-inline-item mx-1 dropdown d-inline-block d-lg-none">
					...
					<a href="#" aria-label="Search" data-toggle="dropdown"
					aria-expanded="false" aria-haspopup="true"
					class="btn-sow-search-toggler d-inline-block text-center text-dark">
						<i class="fi fi-search fs--20"></i> <span
						class="d-block font-weight-light fs--14">검색</span>
				</a>
				...
				<c:choose>
					<c:when
						test="${(isLogOn==true) and (memberInfo.member_id eq'admin') }">
						<!-- my account -->
						<li class="list-inline-item mx-1 dropdown"><a href="#"
							aria-label="My Account" id="dropdownAccountOptions"
							data-toggle="dropdown" aria-expanded="false" aria-haspopup="true"
							class="d-inline-block text-center text-dark"> <i
								class="fi fi-users fs--20"></i> <span
								class="d-block font-weight-light fs--14">내 계정</span>
						</a> <!-- dropdown -->
							<div aria-labelledby="dropdownAccountOptions"
								...
								<div class="dropdown-header">관리자 쩝쩝이</div>

								<div class="dropdown-divider"></div>

								<a href="${contextPath}/admin/main.do" title="Admin Page"
									class="dropdown-item text-truncate font-weight-light"> 관리자
									페이지 </a>


								<div class="dropdown-divider mb-0"></div>

								<a href="${contextPath}/member/logout.do" title="Log Out"
									class="prefix-icon-ignore dropdown-footer dropdown-custom-ignore">
									<i class="fi fi-power float-start"></i> 로그아웃
								</a>
					...
					<c:when test="${isLogOn==true and not empty memberInfo }">
						...
						<li class="list-inline-item mx-1 dropdown"><a href="#"
							...
							<div aria-labelledby="dropdownAccountOptions"
								class="prefix-link-icon prefix-icon-dot dropdown-menu dropdown-menu-clean dropdown-menu-invert dropdown-click-ignore p-0 mt--18 fs--15">
								<div class="dropdown-header">${memberInfo.member_name }님</div>

								<div class="dropdown-divider"></div>

								<a href="${contextPath}/myaccount/account-orders.do"
									title="My Orders"
									class="dropdown-item text-truncate font-weight-light"> 내 주문
								</a> <a href="${contextPath}/myaccount/account-favourites.do"
									title="My Favourites"
									class="dropdown-item text-truncate font-weight-light"> 찜
									리스트 </a> <a href="${contextPath}/myaccount/account-settings.do"
					...
					<c:otherwise>
						<li class="list-inline-item mx-1 dropdown d-none d-sm-block">
							...
							<a href="${contextPath}/member/loginForm.do" aria-label="Login"
							class="d-inline-block text-center text-dark"> <i
								class="fi fi-power fs--20"></i> <span
								class="d-block font-weight-light fs--14">로그인</span>
						</a>
				...
				<!-- 고객센터 -->
				<li class="list-inline-item mx-1 dropdown d-none d-sm-block">
					<!--board/notice-tab.do  --> <a
					href="${contextPath}/board/notice-tab.do" aria-label="signup"
					class="d-inline-block text-center text-dark"> <i
						class="fi fi-support-headphones fs--20"></i> <span
						class="d-block font-weight-light fs--14">고객센터</span>
				</a>
							...
							<div aria-labelledby="mainNavHome"
								...
								<ul class="list-unstyled m-0 p-0">
									<li class="dropdown-item dropdown"><a
										...
										class="dropdown-link" data-toggle="dropdown">육류</a>
										<ul
											class="dropdown-menu dropdown-menu-hover dropdown-menu-block-md shadow-lg b-0 m-0">
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=1"
												class="dropdown-link">육류 1</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=1"
												class="dropdown-link">육류 2</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=1"
												class="dropdown-link">육류 3</a></li>
										</ul></li>
									<li class="dropdown-item dropdown"><a
										href="${contextPath }/product/productList.do?product_category_num=2"
										class="dropdown-link" data-toggle="dropdown">채소</a>
										<ul
											class="dropdown-menu dropdown-menu-hover dropdown-menu-block-md shadow-lg b-0 m-0">
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=2"
												class="dropdown-link">채소1</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=2"
												class="dropdown-link">채소2</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=2"
												class="dropdown-link">채소3</a></li>
										</ul></li>
									<li class="dropdown-item dropdown"><a
										href="${contextPath }/product/productList.do?product_category_num=3"
										class="dropdown-link" data-toggle="dropdown">베이커리</a>
										<ul
											class="dropdown-menu dropdown-menu-hover dropdown-menu-block-md shadow-lg b-0 m-0">
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=3"
												class="dropdown-link">베이커리1</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=3"
												class="dropdown-link">베이커리2</a></li>
											<li class="dropdown-item"><a
												href="${contextPath }/product/productList.do?product_category_num=3"
												class="dropdown-link">베이커리3</a></li>
										</ul></li></li>
				</div>
