					...
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-9">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link nav-link-remember active" data-toggle="tab" href="#tab_account">계정</a>
								</li>

								<li class="nav-item">
									<a class="nav-link nav-link-remember" data-toggle="tab" href="#tab_address">주소</a>
								</li>
							</ul>
													...
													<div class="col-12 col-sm-6 col-md-6">
														...
														<div class="input-group-over">
															<div class="form-label-group mb-3">
																...
																<label for="account_new_password">새 비밀번호</label>
															</div>
										...
										<div class="clearfix mt--60">
											...
											<div id="account_deactivate_confirm" class="collapse" style="">
												...
												<div class="alert b-0 bg-danger-soft mt-3 mb-5 p-4 clearfix">
													...
													<p>
														참고 : 삭제 된 계정은 복원 할 수 없습니다! 
														귀하의 계정은 시스템에서 영구적으로 삭제됩니다. <br>
														이것이 당신이 원하는 것인지 확인하십시오.
													</p>

													<p class="m-0 fs--13">
														보안상의 이유로 귀하의 계정은 30 일 이내에 비활성화되고 영구적으로 삭제됩니다. 
														계정에 다시 로그인하면 삭제 진행이 취소됩니다.
													</p>
								...
								<div id="tab_address" class="tab-pane border bt-0 p-4 shadow-xs">
									...
									<h3 class="h5 clearfix mb-3 mt-3">
										...
										<span class="float-start mt-2">
											<span class="text-primary">배송</span> 주소
										</span>
