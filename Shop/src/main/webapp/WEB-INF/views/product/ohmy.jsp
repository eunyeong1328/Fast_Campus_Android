...
<section class="border-top">
   <div class="container">
         ...
         <c:if test="${empty qnaList }">
            <div class="card border-bottom bl-0 br-0 bt-0">
	            <div class="card-header b-0 p-0 border bg-transparent"
	               id="cleanHeadingBorder1">
	               <h2 class="mb-0">
	                  <button class="fs--18 btn btn-link btn-block btn-lg text-align-start text-decoration-none text-dark" type="button">
      ...
      <div>
         <br><br>
         <a href="${contextPath }/product/productBoardQnaForm.do?product_id=${vo.product_id}&product_qna_num=">
        <button style="float: right;"type="button" class="btn btn-purple btn-soft mb-1">  
               상품문의
          </button>
         </a> 
